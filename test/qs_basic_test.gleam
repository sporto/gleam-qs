...
pub fn default_serialize_test() {
  test_default_serialize([#("a", ["1"])], "?a=1")
  test_default_serialize([#("a", ["1"]), #("b", ["2"])], "?a=1&b=2")
  test_default_serialize([#("a", ["1", "2"])], "?a=1&a=2")
  test_default_serialize([#("b[", ["2", "3"])], "?b%5B=2&b%5B=3")
  test_default_serialize([#("b", ["2|3"])], "?b=2%7C3")
}

pub fn encode_when_serializing_test() {
  test_default_serialize([#("a", ["100% great"])], "?a=100%25%20great")
}
